...
public class CreditTestData {
    ...
    public static final Credit CREDIT1 = new Credit(CREDIT1_ID, new BigDecimal("100.50"), 10.5, BANK1);
    public static final Credit CREDIT2 = new Credit(CREDIT2_ID, new BigDecimal("200.50"), 20.5, BANK1);
    public static final Credit CREDIT3 = new Credit(CREDIT3_ID, new BigDecimal("300.50"), 30.5, BANK2);

    public static Credit getNew() {
        return new Credit(null, new BigDecimal("400.50"), 40.5, BANK1);
    }

    public static Credit getUpdated() {
        Credit updated = new Credit(CREDIT1);
        updated.setInterestRate(50.5);
        updated.setLimit(new BigDecimal("500.50"));
