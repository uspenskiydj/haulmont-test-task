...
public class CreditProposalTestData {
    public static final TestMatcher<CreditProposal> CREDIT_PROPOSAL_MATCHER = TestMatcher.usingIgnoringFieldsComparator(CreditProposal.class, "credit", "customer", "payments");
...
//    public static final CreditProposal CREDIT_PROPOSAL3 = new CreditProposal(CREDIT_PROPOSAL3_ID, new BigDecimal("250.5"), CUSTOMER3, CREDIT3, null);
    ...
    public static final CreditProposal CREDIT_PROPOSAL1 = new CreditProposal(CREDIT_PROPOSAL1_ID, new BigDecimal("50.50"), null, null, null);
    public static final CreditProposal CREDIT_PROPOSAL2 = new CreditProposal(CREDIT_PROPOSAL2_ID, new BigDecimal("150.50"), null, null, null);
    public static final CreditProposal CREDIT_PROPOSAL3 = new CreditProposal(CREDIT_PROPOSAL3_ID, new BigDecimal("250.50"), null, null, null);

    public static CreditProposal getNew() {
//        return new CreditProposal(null, new BigDecimal("350.5"), CUSTOMER1, CREDIT2, null);
        return new CreditProposal(null, new BigDecimal("350.50"), null, null, null);
    }
